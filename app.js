...
function openCart(product) {
  ...
  requestAnimationFrame(() => {
    ...
    // En mobile el CSS posiciona desde top:60px, solo necesita scale
...
// ---- Touch swipe en el carrusel (inicializa UNA sola vez) ----
function initCarouselTouch() { /* llamada vacía, ya inicializado abajo */ }

document.addEventListener('DOMContentLoaded', () => {
  const section = document.getElementById('cart-carousel-section');
  if (!section) return;

  // Decirle al browser que vamos a manejar touch horizontal
...
// ---- Initialize: arrancar en AirPods ----
renderProducts('airpods');
